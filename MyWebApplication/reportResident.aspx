<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reportResident.aspx.cs" Inherits="MyWebApplication.reportResident" EnableEventValidation = "false"%>
...
<center>
                <h1>รายงานค่าใช้จ่าย<asp:Label ID="nameLabel" runat="server"></asp:Label>
                        </h1>
                   <center>
                  <table >
                      <tr>
...
<%--<asp:Button Text="Export" ID="btnExport" OnClick="btnExport_Click" runat="server" />--%>
     <asp:GridView ID="GridView1" runat="server" Width="1000px" CellPadding="8" AutoGenerateColumns="False">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="PCOST" HeaderText="EXPENSES" />
                                        ...
                                        <asp:BoundField DataField="EMPTELEPHONE" HeaderText="TEL" />
                                    </Columns>
                                    <HeaderStyle BackColor="#666666" ForeColor="White" />
                                    <RowStyle BorderColor="#666666" />
                                </asp:GridView>

    <asp:Label ID="total" runat="server" Text="ค่าใช้จ่ายรวม : "></asp:Label>

      <asp:Label ID="showTotal" runat="server" Text=""></asp:Label>
    <asp:Label ID="bath" runat="server" Text=" บาท"></asp:Label>
