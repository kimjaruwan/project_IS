<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reportUser.aspx.cs" Inherits="MyWebApplication.reportUser" %>
...
<center>
                <h1>รายงานข้อมูลผู้ใช้งาน<asp:Label ID="nameLabel" runat="server"></asp:Label>
                        </h1>
                   <center>
                  <table >
                      <tr>
...
<%--<asp:Button Text="Export" ID="btnExport" OnClick="btnExport_Click" runat="server" />--%>
     <asp:GridView ID="GridView1" runat="server" Width="1000px" CellPadding="8" AutoGenerateColumns="False">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="RFIRSTNAME" HeaderText="FIRSTNAME" />
                                        <asp:BoundField DataField="RLASTNAME" HeaderText="LASTNAME" />
                                        <asp:BoundField DataField="RID" HeaderText="ID card number" />
                                        <asp:BoundField DataField="RADDRESS" HeaderText="ADDRESS" />
                                        <asp:BoundField DataField="RTELEPHONE" HeaderText="TELEPHONE" />
                                    </Columns>
                                    <HeaderStyle BackColor="#666666" ForeColor="White" />
                                    <RowStyle BorderColor="#666666" />
                                </asp:GridView>

    <asp:Label ID="total" runat="server" Text="ผู้ใช้งานทั้งหมด รวม : "></asp:Label>

      <asp:Label ID="showTotal" runat="server" Text=""></asp:Label>
    <asp:Label ID="bath" runat="server" Text=" user"></asp:Label>
