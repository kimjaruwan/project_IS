<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reportStatus.aspx.cs" Inherits="MyWebApplication.reportStatus" %>
...
<center>
                <h1>รายงานสถานะคำร้องเรียน<asp:Label ID="nameLabel" runat="server"></asp:Label>
                        </h1>
                   <center>
                  <table >
                      <tr>
...
<asp:Label ID="total" runat="server" Text="สถานะรับเรื่อง รวม : "></asp:Label>
    ...
    <asp:Label ID="unit1" runat="server" Text=" คำร้องเรียน"></asp:Label>
      ...
      <tr>
    <td>
 <asp:Label ID="Label1" runat="server" Text="สถานะอยู่ระหว่างดำเนินการ รวม : "></asp:Label>
    ...
    <asp:Label ID="Label3" runat="server" Text=" คำร้องเรียน"></asp:Label>
        ...
        <tr>
        <td>
<asp:Label ID="Label4" runat="server" Text="สถานะเสร็จสิ้น รวม : "></asp:Label>
    ...
    <asp:Label ID="Label6" runat="server" Text=" คำร้องเรียน"></asp:Label>
            ...
            <tr>
        <td>
<asp:Label ID="Label7" runat="server" Text="สรุปรวมทั้งสิ้น : "></asp:Label>
